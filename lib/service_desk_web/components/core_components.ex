defmodule ServiceDeskWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ServiceDeskWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-[#0d4e62] hover:bg-[#a81616] py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ServiceDeskWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ServiceDeskWeb.Gettext, "errors", msg, opts)
    end
  end
